...
CREATE TABLE `petty_cash_expenses` (
  ...
  `evidence_mime_type` varchar(100) DEFAULT NULL,
  `evidence_width` int(10) unsigned DEFAULT NULL,
  `evidence_height` int(10) unsigned DEFAULT NULL,
  `evidence_original_filename` varchar(255) DEFAULT NULL,
...
CREATE TABLE `petty_cash_funds` (
  ...
  `fund_status` enum('UNDECLARED', 'DECLARED', 'SUSPENDED', 'CLOSED') DEFAULT 'UNDECLARED',
