...
class PrintTicketType(str, enum.Enum):
    ...
    TICKET_APERTURA   = "TICKET_APERTURA"
    TICKET_ARQUEO     = "TICKET_ARQUEO"
    TICKET_CIERRE     = "TICKET_CIERRE"
    TICKET_ANULACION  = "TICKET_ANULACION"
    TICKET_RETIRO     = "TICKET_RETIRO"
    TICKET_INGRESO    = "TICKET_INGRESO"
    TICKET_GASTO      = "TICKET_GASTO"
    TICKET_REPORTE_X  = "TICKET_REPORTE_X"
    TICKET_REPORTE_Z  = "TICKET_REPORTE_Z"
