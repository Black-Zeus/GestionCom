...
async def _run_schema_migrations():
    ...
    enum_extensions = [
        ...
        ("print_jobs", "ticket_type", "TICKET_APERTURA",
         "ALTER TABLE print_jobs MODIFY COLUMN ticket_type ENUM('TICKET_VENTA','TICKET_CAMBIO','TICKET_DEVOLUCION','TICKET_PRUEBA','TICKET_APERTURA','TICKET_ARQUEO','TICKET_CIERRE') NOT NULL"),
        ("print_jobs", "ticket_type", "TICKET_ARQUEO",
         "ALTER TABLE print_jobs MODIFY COLUMN ticket_type ENUM('TICKET_VENTA','TICKET_CAMBIO','TICKET_DEVOLUCION','TICKET_PRUEBA','TICKET_APERTURA','TICKET_ARQUEO','TICKET_CIERRE') NOT NULL"),
        ("print_jobs", "ticket_type", "TICKET_CIERRE",
         "ALTER TABLE print_jobs MODIFY COLUMN ticket_type ENUM('TICKET_VENTA','TICKET_CAMBIO','TICKET_DEVOLUCION','TICKET_PRUEBA','TICKET_APERTURA','TICKET_ARQUEO','TICKET_CIERRE') NOT NULL"),
        ("print_jobs", "ticket_type", "TICKET_ANULACION",
         "ALTER TABLE print_jobs MODIFY COLUMN ticket_type ENUM('TICKET_VENTA','TICKET_CAMBIO','TICKET_DEVOLUCION','TICKET_PRUEBA','TICKET_APERTURA','TICKET_ARQUEO','TICKET_CIERRE','TICKET_ANULACION','TICKET_RETIRO','TICKET_INGRESO','TICKET_GASTO','TICKET_REPORTE_X','TICKET_REPORTE_Z') NOT NULL"),
        ("print_jobs", "ticket_type", "TICKET_RETIRO",
         "ALTER TABLE print_jobs MODIFY COLUMN ticket_type ENUM('TICKET_VENTA','TICKET_CAMBIO','TICKET_DEVOLUCION','TICKET_PRUEBA','TICKET_APERTURA','TICKET_ARQUEO','TICKET_CIERRE','TICKET_ANULACION','TICKET_RETIRO','TICKET_INGRESO','TICKET_GASTO','TICKET_REPORTE_X','TICKET_REPORTE_Z') NOT NULL"),
        ("print_jobs", "ticket_type", "TICKET_INGRESO",
         "ALTER TABLE print_jobs MODIFY COLUMN ticket_type ENUM('TICKET_VENTA','TICKET_CAMBIO','TICKET_DEVOLUCION','TICKET_PRUEBA','TICKET_APERTURA','TICKET_ARQUEO','TICKET_CIERRE','TICKET_ANULACION','TICKET_RETIRO','TICKET_INGRESO','TICKET_GASTO','TICKET_REPORTE_X','TICKET_REPORTE_Z') NOT NULL"),
        ("print_jobs", "ticket_type", "TICKET_GASTO",
         "ALTER TABLE print_jobs MODIFY COLUMN ticket_type ENUM('TICKET_VENTA','TICKET_CAMBIO','TICKET_DEVOLUCION','TICKET_PRUEBA','TICKET_APERTURA','TICKET_ARQUEO','TICKET_CIERRE','TICKET_ANULACION','TICKET_RETIRO','TICKET_INGRESO','TICKET_GASTO','TICKET_REPORTE_X','TICKET_REPORTE_Z') NOT NULL"),
        ("print_jobs", "ticket_type", "TICKET_REPORTE_X",
         "ALTER TABLE print_jobs MODIFY COLUMN ticket_type ENUM('TICKET_VENTA','TICKET_CAMBIO','TICKET_DEVOLUCION','TICKET_PRUEBA','TICKET_APERTURA','TICKET_ARQUEO','TICKET_CIERRE','TICKET_ANULACION','TICKET_RETIRO','TICKET_INGRESO','TICKET_GASTO','TICKET_REPORTE_X','TICKET_REPORTE_Z') NOT NULL"),
        ("print_jobs", "ticket_type", "TICKET_REPORTE_Z",
         "ALTER TABLE print_jobs MODIFY COLUMN ticket_type ENUM('TICKET_VENTA','TICKET_CAMBIO','TICKET_DEVOLUCION','TICKET_PRUEBA','TICKET_APERTURA','TICKET_ARQUEO','TICKET_CIERRE','TICKET_ANULACION','TICKET_RETIRO','TICKET_INGRESO','TICKET_GASTO','TICKET_REPORTE_X','TICKET_REPORTE_Z') NOT NULL"),
    ]
    new_tables = [
        ...
        """CREATE TABLE IF NOT EXISTS print_jobs (
            ...
            ticket_type ENUM('TICKET_VENTA','TICKET_CAMBIO','TICKET_DEVOLUCION','TICKET_PRUEBA','TICKET_APERTURA','TICKET_ARQUEO','TICKET_CIERRE','TICKET_ANULACION','TICKET_RETIRO','TICKET_INGRESO','TICKET_GASTO','TICKET_REPORTE_X','TICKET_REPORTE_Z') NOT NULL,
