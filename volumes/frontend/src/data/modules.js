...
export const moduleGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'sales-points-admin', label: 'Puntos de venta', path: '/admin/sales-points', icon: Store, weight: 34, permissions: ['SALES_POINTS_ACCESS', 'SALES_POINTS_MANAGE'] },
      { id: 'operator-assignments-admin', label: 'Asignacion de operadores', path: '/admin/operator-assignments', icon: UserCheck, weight: 36, permissions: ['OPERATOR_ASSIGNMENTS_ACCESS', 'OPERATOR_ASSIGNMENTS_MANAGE'] },
