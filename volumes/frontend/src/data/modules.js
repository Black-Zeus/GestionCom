...
export const moduleGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'product-brand-models', label: 'Marcas y modelos de productos', path: '/products/brands-models', icon: Tags, weight: 78, permissions: ['PRODUCT_BRAND_MODELS_ACCESS', 'PRODUCT_BRAND_MODELS_MANAGE', 'FOUNDATION_MAINTAINERS_ACCESS'] },
