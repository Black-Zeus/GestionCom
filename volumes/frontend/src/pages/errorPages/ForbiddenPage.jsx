...
Justificación: [Escriba aquí por qué necesita acceso]
    ...
    return (
      ...
      `}>
                ...
                <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl border border-white/20 dark:border-gray-700 rounded-lg shadow-2xl shadow-amber-500/10 dark:shadow-amber-500/20 p-8">
                        ...
                        <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800/50 rounded-md p-4 mb-6 max-w-2xl mx-auto">
                            <div className="flex items-start gap-3">
                                ...
                                <div className="min-w-0 flex-1">
                                    <p className="text-sm font-medium text-amber-700 dark:text-amber-300 mb-1">Usuario actual:</p>
                                    <p className="text-sm text-amber-600 dark:text-amber-400 break-all">
