        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-200 dark:border-gray-700">
            <div className="flex items-center">
              <div className="flex-1">
                ...
                <p className="text-2xl font-bold text-white-600 dark:text-green-400">
                  {stats.activeUsers}
                </p>
              </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-200 dark:border-gray-700">
            <div className="flex items-center">
              ...
              <div className="w-12 h-12 bg-gray-100 dark:bg-gray-900/30 rounded-lg flex items-center justify-center">
                <span className="text-green-600 dark:text-gray-400 text-xl">
                  ⚪
                </span>
              </div>
            </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-200 dark:border-gray-700">
            <div className="flex items-center">
              ...
              <div className="w-12 h-12 bg-white-100 dark:bg-purple-900/30 rounded-lg flex items-center justify-center">
