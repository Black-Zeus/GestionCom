...
const CashPOSFilters = ({ filters, onFilterChange, onClearFilters }) => {
    ...
    <div className="flex gap-4 mb-6 flex-wrap">
      ...
      <div className="flex-1 min-w-[250px] relative">
        ...
        <input
          ...
          placeholder="Buscar por código, nombre o terminal..."
      ...
      <div className="flex gap-3 flex-wrap">
        <select
          ...
          className="px-4 py-3 border-2 border-gray-200 rounded-lg text-sm bg-white cursor-pointer focus:outline-none focus:border-green-600 transition-all"
        >
          <option value="">Todas las bodegas</option>
          <option value="1">Bodega Central</option>
          <option value="2">Tienda Centro</option>
          <option value="3">Tienda Mall Plaza</option>
          <option value="4">Bodega Norte</option>
        </select>
