    ...
    reports: [
      {
        ...
        description:
          'Clientes clasificados por monto de ventas, transacciones, ticket promedio y participación dentro del período.',
        type: 'Reporte gerencial',
        path: '/reports/customers?report=customer-ranking',
        available: true,
        tags: ['Período', 'Sucursal', 'Cliente', 'Reporte PDF'],
      },
      {
        id: 'customer-credit-status',
        label: 'Estado de crédito',
        description:
          'Límite, crédito utilizado, crédito disponible, días de pago, nivel de riesgo y bloqueo automático por cliente.',
        type: 'Reporte operativo',
        path: '/reports/customers?report=customer-credit-status',
        available: true,
        tags: ['Crédito', 'Riesgo', 'Cliente', 'Exportación CSV'],
      },
      {
        id: 'customer-payment-history',
        label: 'Historial de pagos',
        description:
          'Pagos recibidos de clientes y sus aplicaciones a documentos por período, medio de pago y estado.',
        type: 'Reporte operativo',
        path: '/reports/customers?report=customer-payment-history',
        available: true,
        tags: ['Pagos', 'Período', 'Medio de pago', 'Exportación CSV'],
      },
      {
        id: 'customer-authorized-buyers',
        label: 'Compradores autorizados',
        description:
          'Personas autorizadas para comprar por cuenta de clientes, nivel de autorización, límite de compra y vigencia.',
        type: 'Reporte operativo',
        path: '/reports/customers?report=customer-authorized-buyers',
        available: true,
        tags: ['Cliente', 'Autorizados', 'Límite compra', 'Exportación CSV'],
      },
      {
        id: 'customer-geography',
        label: 'Clientes por zona',
        description:
          'Distribución de clientes por región, ciudad, tipo de cliente, estado y grupo de lista de precios.',
        type: 'Reporte gerencial',
        path: '/reports/customers?report=customer-geography',
        available: true,
        tags: ['Región', 'Ciudad', 'Tipo cliente', 'Gráfico'],
      },
    ],
  },
  {
