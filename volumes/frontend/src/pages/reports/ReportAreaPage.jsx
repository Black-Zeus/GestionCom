...
const REPORT_COMPONENTS = {
  ...
  'customer-ranking':           lazy(() => import('./CustomerRankingReport')),
  'customer-credit-status':     lazy(() => import('./CustomerCreditStatusReport')),
  'customer-payment-history':   lazy(() => import('./CustomerPaymentHistoryReport')),
  'customer-authorized-buyers': lazy(() => import('./CustomerAuthorizedBuyersReport')),
  'customer-geography':         lazy(() => import('./CustomerGeographyReport')),
