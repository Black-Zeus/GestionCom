...
const AccountsReceivableIdentification = ({
  selectedCustomer,
  onOpenSearch,
}) => {
  const getCustomerDisplayName = () => {
    if (!selectedCustomer) return "Ningún cliente seleccionado";
    return selectedCustomer.commercial_name || selectedCustomer.legal_name || "-";
  };
...
export default AccountsReceivableIdentification;