...
const detailNavigationRoutes = [
  ...
  },
  {
    ...
    pattern: /^\/config\/company\/edit\/([^/?#]+)/,
    basePath: '/config/company',
    group: 'Configuracion de empresa',
    fallbackLabel: 'Editar empresa',
    getLabelFromCode: (code) => `Editar empresa${code ? ` - ${decodeURIComponent(code)}` : ''}`,
    getTooltipFromCode: (code) => `Editar empresa: ${decodeURIComponent(code)}`,
  },
  {
    id: 'company-config-new',
    pattern: /^\/config\/company\/new$/,
    basePath: '/config/company',
    group: 'Configuracion de empresa',
    fallbackLabel: 'Nueva empresa',
    getLabelFromCode: () => 'Nueva empresa',
    getTooltipFromCode: () => 'Crear nueva empresa',
  },
  {
    id: 'product-variants-by-code',
    pathname: '/inventory/products',
    queryParam: 'product_code',
    basePath: '/inventory/products',
    group: 'Catalogo de productos',
    fallbackLabel: 'SKU / Variaciones',
    getLabelFromCode: (code) => `Catalogo de productos: ${code}`,
    getTooltipFromCode: (code) => `SKU / Variaciones del producto: ${code}`,
  },
  {
    id: 'product-variants-by-id',
    pathname: '/inventory/products',
    queryParam: 'product_id',
    basePath: '/inventory/products',
    group: 'Catalogo de productos',
    fallbackLabel: 'SKU / Variaciones',
    getLabelFromCode: (id) => `Catalogo de productos: #${id}`,
    getTooltipFromCode: (id) => `SKU / Variaciones del producto ID: ${id}`,
  },
  {
